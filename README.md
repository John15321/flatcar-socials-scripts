...
7. Get your **Guild ID**: enable Developer Mode in Discord settings, then right-click your server name → **Copy Server ID**
...
# See options for a specific platform
flatcar-socials discord --help
```
...
flatcar-socials discord --token "your-bot-token" --guild-id 123456789
...
| Metric | Description |
|--------|-------------|
| `total_members` | Total server member count |
...
> **Note:** The Flatcar Matrix channel is now inactive, but you can still use this tool to scrape historical data.
